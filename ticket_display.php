...
<div class="menu">
    ...
    <div class="ticket">
        ...
        <div class="ticket-info">
            ...
            <p><strong>Airline:</strong> <?php echo $_GET['airline']; ?></p>
            ...
            <p><strong>Return Date:</strong> <?php echo $_GET['return_date']; ?></p>
            <p><strong>Return Time:</strong> <?php echo $_GET['return_time']; ?></p>
